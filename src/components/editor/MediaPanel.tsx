        ...
        {config.heroImage ? (
          <div className="relative">
            ...
            <button
              ...
              className="absolute top-2 right-2 rounded-full bg-white px-2 py-0.5 text-xs text-red-600 shadow"
            >
              Xóa
            </button>
          </div>
          ...
          {config.gallery.map((url, i) => (
            <div key={i} className="relative">
              ...
              <button
                ...
                className="absolute top-1 right-1 rounded-full bg-white px-1.5 py-0.5 text-xs text-red-600 shadow"
              >
                ✕
              </button>
            </div>
